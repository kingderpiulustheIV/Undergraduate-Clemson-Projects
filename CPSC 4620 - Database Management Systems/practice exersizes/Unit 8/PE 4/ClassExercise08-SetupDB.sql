...
DROP SCHEMA IF EXISTS InstantRide08;
CREATE SCHEMA InstantRide08;
USE InstantRide08;

DROP USER IF EXISTS 'dbtester';
CREATE USER 'dbtester' IDENTIFIED BY 'CPSC4620'; 
GRANT ALL ON InstantRide08.* TO 'dbtester';
...
START TRANSACTION;
INSERT INTO MAINTENANCES(CAR_ID, MAINTENANCE_TYPE_ID, MAINTENANCE_DUE) 
SELECT CAR_ID, '1', '2021-09-01' FROM CARS
ROLLBACK;
SET autocommit = ON;
