    ...
    void ImageViewer::Keyboard(unsigned char key, int x, int y)
    {
        switch(key) {
            ...
            case '0':
                ...
                break;
            case 'j':
                // lowercase j: save current image as JPEG
                if (imgProc->IsLoaded()) {
                    string outputFilename = "demowritetoafile.jpg";
                    cout << "Saving JPEG image to " << outputFilename << "..." << endl;
                    if (imgProc->WriteImageJPEG(outputFilename)) {
                        cout << "JPEG image saved successfully!" << endl;
                        cout << "--------------------------------------------------------------" << endl;  
                    } else {
                        cout << "Failed to save JPEG image!" << endl;
                        cout << "--------------------------------------------------------------" << endl;
                    }
                } else {
                ...
                break;
            case 'o':
                // 'o' key: save current image as EXR (full floating point)
                if (imgProc->IsLoaded()) {
                    string outputFilename = "demowritetoafile.exr";
                    cout << "Saving EXR image to " << outputFilename << "..." << endl;
                    if (imgProc->WriteImageEXR(outputFilename)) {
                        cout << "EXR image saved successfully!" << endl;
                        cout << "--------------------------------------------------------------" << endl;  
                    } else {
                        cout << "Failed to save EXR image!" << endl;
                        cout << "--------------------------------------------------------------" << endl;
                    }
                } else {
                    cout << "No image loaded to save!" << endl;
            ...
            case 'C':
                if (imgProc->IsLoaded()) {
                    ...
                    processedImage.ConvertToContrastUnits();
                    ...
                    *imgProc = processedImage;
                    ...
                    CreateTexture();
                    cout << "Contrast conversion applied and display updated!" << endl;
                    cout << "--------------------------------------------------------------" << endl;
                } else {
                    cout << "No image loaded for contrast conversion!" << endl;
                    cout << "--------------------------------------------------------------" << endl;
                }
                break;
            case 'H':
                if (imgProc->IsLoaded()) {
                    // Create a deep copy for processing
                    ImgProc processedImage(*imgProc);
                    processedImage.HistogramEqualization();
                    ...
                    *imgProc = processedImage;
                    ...
                    // Update texture with new image data
                    CreateTexture();
                    cout << "Histogram equalization applied and display updated!" << endl;
                    cout << "--------------------------------------------------------------" << endl;
                } else {
                    cout << "No image loaded for histogram equalization!" << endl;
                    cout << "--------------------------------------------------------------" << endl;
                }
                break;
            case 'g':
