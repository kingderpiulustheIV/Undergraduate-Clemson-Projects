...
public class TestGameBoardMem
{
    ...
    private IGameBoard InitializeGameBoard(int row, int column, int numTokens) {
        IGameBoard gb = new GameBoardMem(row, column, numTokens);
        return gb;
    }
    ...
    @Test
   public void checkVertWinBottomTrue()
    {
        ...
        String expOutput = expOutput(outputArray, gb);
        assertEquals(gb.toString(), expOutput);
        assertEquals(true,gb.checkVertWin(new BoardPosition(11,0),'X'));


    }

    @Test
   public void checkVertWinBottomFlase()
    {
        ...
        String expOutput = expOutput(outputArray, gb);
        assertEquals(gb.toString(), expOutput);
        assertEquals(false,gb.checkVertWin(new BoardPosition(0,10),'X'));


    }

    @Test
   public void checkVertWinTopFalse()
    {
        ...
        String expOutput = expOutput(outputArray, gb);
        assertEquals(gb.toString(), expOutput);
        assertEquals(false,gb.checkVertWin(new BoardPosition(10,0),'X'));


    }

    @Test
   public void checkVertWinTopTrue()
    {
    ...
    @Test
   public void checkHorzWinBotLeftTrue()
    {
    ...
    @Test
   public void checkHorzWinTopRightTrue()
    {
        ...
        String expOutput = expOutput(outputArray, gb);
        assertEquals(gb.toString(), expOutput);
        assertEquals(true,gb.checkHorizWin(new BoardPosition(10,10),'X'));
    ...
    @Test
   public void checkHorzWinBotRightFalse()
    {
        ...
        String expOutput = expOutput(outputArray, gb);
        assertEquals(gb.toString(), expOutput);
        assertEquals(false,gb.checkHorizWin(new BoardPosition(10,10),'X'));


    }

    @Test
   public void checkHorzWinTopLeftTrue()
    {
        ...
        String expOutput = expOutput(outputArray, gb);
        assertEquals(gb.toString(), expOutput);
        assertEquals(true,gb.checkHorizWin(new BoardPosition(10,2),'X'));
    ...
    @Test
    public void test_checkDiagWin_win_middle_left_to_middle_to_right() {
        ...
        String expOutput = expOutput(outputArray, gb);
        assertEquals(gb.toString(), expOutput);
        assertEquals(gb.checkDiagWin(pos, 'X'), expectedOutput);
        assertEquals(false,gb.checkDiagWin(new BoardPosition(2,2),'X'));
    ...
    @Test
    public void checkDiagramWinRightToLeftBotRightTrue()
    {
   ...
   public void checkIfFree99True()
    ...
    @Test
   public void checkWhatsAtPos_checks_False() {
    ...
    @Test
   public void checkWhatsAtPos_checks_true() {
        IGameBoard gb = InitializeGameBoard(13, 13, 6);
        char[][] outputArray = new char[13][13];
        for (int i = 0; i < 13; i++) {
            for (int j = 0; j < 13; j++) {
    ...
    @Test
   public void checkWhatsAtPos_empty_position() {
    ...
    @Test
   public void checkWhatsAtPos_top_of_inserted_column() {
    ...
    @Test
   public void checksWhatsAtPos_rightmost_position_inserted_row() {
    ...
    @Test
   public void checkTie_full_board_no_wins() {
    ...
    @Test
   public void checkTie_partially_filled_board_with_win() {
   ...
   public void checkTie_empty_board() {
    ...
    @Test
   public void checkTie_partaily_filled_board_with_no_win() {
    ...
    @Test
   public void checkDiagtWinLeftToRightBotTrue()
    {
    ...
    @Test
   public void checkDiagtWinLeftToRightFalse()
    {
    ...
    @Test
   public void checkDiagtWinLeftToRightTopRightTrue()
    {
    ...
    @Test
   public void checkDiagtWinRightToLeftBotRightTrue()
    {
    ...
    @Test
   public void checkDiagtWinRightToLeftTopLeftTrue()
    {
        ...
        String expOutput = expOutput(outputArray, gb);
        assertEquals(gb.toString(), expOutput);
        assertEquals(true,gb.checkDiagWin(new BoardPosition(6,0),'X'));


    }

    @Test
   public void checkDiagtWinRightToLeftFalse()
    {
        ...
        String expOutput = expOutput(outputArray, gb);
        assertEquals(gb.toString(), expOutput);
        assertEquals(false,gb.checkDiagWin(new BoardPosition(6,0),'X'));


    }

    @Test
   public void checkDiagtWinRightToLeftBotLeftTrue()
    {
