"""
Django settings for safedriverprogram project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '54.236.249.73']
...
INSTALLED_APPS = [
    ...
    'driver_program.apps.DriverProgramConfig',
...
ROOT_URLCONF = 'safedriverprogram.urls'
...
WSGI_APPLICATION = 'safedriverprogram.wsgi.application'
